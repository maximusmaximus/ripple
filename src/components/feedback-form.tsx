...
type Sent = { number: number; url: string; kind: FeedbackKind };
...
export function FeedbackComposer({
  ...
  const shell = framed
    ? "flex flex-col gap-2 rounded-2xl border border-line bg-fg/8 p-3"
    : "flex flex-col gap-2";
  ...
  return (
    ...
    >
      <TipCopy>Lands on the public list as a tracked issue. First line becomes the title.</TipCopy>
